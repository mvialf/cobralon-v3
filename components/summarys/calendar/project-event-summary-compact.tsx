...
interface ProjectEventSummaryCompactProps {
  projectId: string
...
/**
 * Versión compacta de ProjectEventSummary para vistas de calendario.
 *
 ...
 */
export function ProjectEventSummaryCompact({
  projectId,
  projectNumber,
  projectName,
  customerName,
  ...
  tasks,
  className,
}: ProjectEventSummaryCompactProps) {
  const hasSpecs =
