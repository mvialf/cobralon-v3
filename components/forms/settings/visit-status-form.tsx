...
interface VisitStatusFormProps {
  onSubmit: (data: VisitStatusFormValues) => void | Promise<void>
  defaultValues?: Partial<VisitStatusFormValues>
  badgeColors: BadgeColor[]
}

export interface VisitStatusFormHandle {
  submit: () => void
  reset: () => void
}

export const VisitStatusForm = React.forwardRef<VisitStatusFormHandle, VisitStatusFormProps>(
  ({ onSubmit, defaultValues, badgeColors }, ref) => {
    const form = useForm<VisitStatusFormValues>({
      resolver: zodResolver(visitStatusSchema),
      defaultValues: {
        name: '',
          ...
          <FormField
            ...
            render={({ field }) => (
              <FormItem>
                ...
                <FormControl>
                  <Input placeholder="Ej: Agendada" {...field} />
                </FormControl>
                <FormMessage />
              </FormItem>
            )}
...
VisitStatusForm.displayName = 'VisitStatusForm'
