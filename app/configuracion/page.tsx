            ...
            <div className="grid gap-6">
                ...
                <div className="grid flex-1 gap-2">
                  ...
                  <Popover open={openPais} onOpenChange={setOpenPais}>
                    <PopoverTrigger asChild>
                      ...
                      >
                        {pais
                          ? paises.find((p) => p.value === pais)?.label
                          : 'Selecciona un país...'}
              ...
              <div className="rounded-lg border bg-muted/40 p-4">
                <p className="text-muted-foreground text-sm">
                  💡 <strong>Tip:</strong> La configuración automática aplica los valores más
                  comunes para el país seleccionado. Puedes personalizarla si tus necesidades son
                  diferentes.
                </p>
              </div>
            </div>
