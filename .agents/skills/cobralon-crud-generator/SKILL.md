...
description: Usar para crear o extender entidades CRUD no financieras en Cobralon con validaciones Zod, formularios React Hook Form, dialogs, API routes, tablas TanStack y páginas Next.js. Evitar para lógica financiera; usar cobralon-financial-logic si hay pagos, créditos, balances o allocations.
---
...
| API route | kebab-case según convención existente | `app/api/project-status/` |
| Página | kebab-case según convención existente | `app/project-status/page.tsx` |

## Checklist de Calidad

- [ ] Schema Prisma existe; si requiere cambios, Prisma se ejecuta solo por decisión explícita del usuario
...
- **API routes** (`docs/rules/api-routes.md`): validación Zod, códigos HTTP, transacciones
- **Componentes** (`docs/rules/components.md`): path aliases, Server Components First, shadcn/ui
- **Database** (`docs/rules/database.md`): comandos Prisma, transacciones financieras
