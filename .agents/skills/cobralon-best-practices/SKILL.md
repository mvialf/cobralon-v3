...
description: Usar al escribir, revisar o refactorizar código Cobralon en Next.js 15, React 19, Prisma, React Query, API routes, Server Components, formularios, performance, bundle size, raw SQL, query keys o convenciones de componentes. Prioriza patrones reales del repo y docs/rules.
---
...
| Promise.all en endpoints con queries independientes | `app/api/projects/[id]/route.ts` |
...
| React Hook Form + Zod | `components/forms/customers/customer-form.tsx` |
...
### 2. xlsx importado estáticamente
