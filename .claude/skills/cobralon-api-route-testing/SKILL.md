...
description: Templates copy-paste y checklists para escribir tests de API routes en Cobralon.
---
...
(updateProjectBalance, creditBalance), o generar test completo para ruta existente.
