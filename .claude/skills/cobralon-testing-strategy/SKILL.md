...
```bash
npm test                              # Todos los unit tests (watch mode)
npm test -- --run                     # Unit tests sin watch
npm test -- lib/business-logic/       # Solo business logic
...
|---------|-------|-------------|
| Skill global `vitest` | API genérica de Vitest | Documentación API |
| Skill `cobralon-financial-logic` | Invariantes financieros a testear | Reglas de negocio |
| Rule `database.md` | Comandos Prisma | Estructura de mocks |
