...
## Error boundaries (estado actual)

El proyecto NO tiene archivos `error.tsx`. Los errores de rendering se manejan con:

1. React Query `isError` state en componentes
2. Conditional rendering en caso de error
3. Toast para errores de mutations

Si se necesitan error boundaries en el futuro:
